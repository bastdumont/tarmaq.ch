...
const translations = {
    fr: {
        ...
        'charter.mission.p1': 'tarmaq est né d\'une conviction profonde : la technologie ne doit pas être un privilège réservé à quelques-uns, mais une opportunité accessible à tous les jeunes talents, quelle que soit leur origine sociale, économique ou géographique.',
    ...
    en: {
        ...
        'charter.mission.p1': 'tarmaq was born from a deep conviction: technology should not be a privilege reserved for a few, but an opportunity accessible to all young talents, regardless of their social, economic, or geographic background.',
    ...
    de: {
        ...
        'charter.mission.p1': 'tarmaq wurde aus einer tiefen Überzeugung geboren: Technologie sollte kein Privileg für wenige sein, sondern eine Chance, die allen jungen Talenten zugänglich ist, unabhängig von ihrer sozialen, wirtschaftlichen oder geografischen Herkunft.',
    ...
    it: {
        ...
        'charter.mission.p1': 'tarmaq è nato da una profonda convinzione: la tecnologia non deve essere un privilegio riservato a pochi, ma un\'opportunità accessibile a tutti i giovani talenti, indipendentemente dalla loro origine sociale, economica o geografica.',
