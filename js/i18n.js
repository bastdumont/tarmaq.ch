...
const translations = {
    ...
    en: {
        ...
        'tokenomics.title': 'TARMAQ Token (TQ) — Impact Tokenomics',
        ...
        'tokenomics.architecture.quote': '« 1 TQ = 1 validated impact unit (mentoring hour, deliverable, donation, certified training) »',
        ...
        'tokenomics.distribution.table1.allocation': '30% (3,000,000 TQ)',
        ...
        'tokenomics.circulation.item2.text': '(TQ → partial subsidy, then burn).',
        'tokenomics.circulation.item3.title': 'Sponsorship',
        'tokenomics.circulation.item3.text': ': "impact staking" of TQ to fund other youth.',
        'tokenomics.circulation.item4.title': 'Conversion',
        'tokenomics.circulation.item4.text': 'via reserve (TQ ↔ CHF) according to DAO rules.',
        ...
        'tokenomics.reserve.description': '10% of each donation/sponsorship is converted to stablecoins (USDC/CHF) and deposited in an impact reserve. This reserve creates a value floor for TQ and feeds liquidity.',
        ...
        'tokenomics.reserve.item2.text': 'TQ repurchase by the association (quarterly windows).',
        'tokenomics.reserve.item3.title': 'CH On-ramp',
        'tokenomics.reserve.item3.text': 'regulated partners (MtPelerin / crypto banks) for TQ ↔ CHF.',
        ...
        'tokenomics.governance.item1': '🗳️ 1 TQ = 1 vote (2% cap per entity).',
        ...
        'tokenomics.alignment.item1': '💼 Mixed compensation CHF + TQ (vesting 24-36 months).',
        'tokenomics.alignment.item2': '🏅 TQ bonus for open-source deliverables and educational modules.',
        'tokenomics.alignment.item3': '🎯 Impact bonuses: additional TQ if pedagogical objectives achieved.',
        ...
        'tokenomics.roadmap.year4.description': 'CH On-ramp (TQ ↔ CHF)',
    ...
    it: {
        ...
        // Tokenomics Page
        'tokenomics.badge': '🎯 Économie d\'impact • Utility + Governance • Traçabilité on-chain',
        'tokenomics.title': 'TARMAQ Token (TQ) — Tokenomics d\'Impact',
        'tokenomics.subtitle': 'Un modèle suisse qui transforme chaque heure de mentorat, chaque franc investi et chaque projet livré en valeur mesurable — au service des jeunes, des mentors, des entreprises et des donateurs.',
        'tokenomics.cta.distribution': 'Voir la distribution',
        'tokenomics.cta.reserve': 'Mécanisme de réserve',
        'tokenomics.cta.roadmap': 'Feuille de route 5 ans',
        'tokenomics.kpi1.label': 'Supply fixe',
        'tokenomics.kpi1.description': 'Aucune inflation. Émission liée à la preuve d\'impact (mentorat, projets, dons).',
        'tokenomics.kpi2.label': 'Réserve d\'impact',
        'tokenomics.kpi2.description': '10% des dons et mécénats versés en stablecoins pour soutenir un plancher de valeur.',
        'tokenomics.kpi3.label': 'Gouvernance',
        'tokenomics.kpi3.description': 'Association + smart contracts : votes, budgets, bourses, projets financés.',
        'tokenomics.architecture.title': 'Architecture du token',
        'tokenomics.architecture.utility.title': 'Utility',
        'tokenomics.architecture.utility.text': 'formations, événements, coworking, bourses de mobilité.',
        'tokenomics.architecture.governance.title': 'Governance',
        'tokenomics.architecture.governance.text': 'vote DAO (poids plafonné à 2%) pour éviter la concentration.',
        'tokenomics.architecture.impact.title': 'Impact',
        'tokenomics.architecture.impact.text': 'certificats NFT pour mécènes & suivi on-chain des projets.',
        'tokenomics.architecture.quote': '« 1 TQ = 1 unité d\'impact validée (heure mentorat, livrable, don, formation certifiée) »',
        'tokenomics.distribution.title': 'Distribution initiale (Genèse)',
        'tokenomics.distribution.legend1': 'Éducation & Jeunesse 30%',
        'tokenomics.distribution.legend2': 'Mentors & Devs 20%',
        'tokenomics.distribution.legend3': 'Entreprises 15%',
        'tokenomics.distribution.legend4': 'Donateurs 15%',
        'tokenomics.distribution.legend5': 'Réserve & Liquidity 10%',
        'tokenomics.distribution.legend6': 'Équipe & Ops 5%',
        'tokenomics.distribution.legend7': 'DAO 5%',
        'tokenomics.distribution.table1.category': 'Éducation & Jeunesse',
        'tokenomics.distribution.table1.allocation': '30% (3 000 000 TQ)',
        'tokenomics.distribution.table1.vesting': 'Bourses, voyages, récompenses étudiants',
        'tokenomics.distribution.table2.category': 'Mentors & Développeurs',
        'tokenomics.distribution.table2.allocation': '20% (2 000 000)',
        'tokenomics.distribution.table2.vesting': 'Vesting 12–36 mois selon contributions',
        'tokenomics.distribution.table3.category': 'Entreprises partenaires',
        'tokenomics.distribution.table3.allocation': '15% (1 500 000)',
        'tokenomics.distribution.table3.vesting': 'Projets, stages, mécénat en nature',
        'tokenomics.distribution.table4.category': 'Donateurs & Fondations',
        'tokenomics.distribution.table4.allocation': '15% (1 500 000)',
        'tokenomics.distribution.table4.vesting': 'Certificats NFT d\'impact + reporting',
        'tokenomics.distribution.table5.category': 'Réserve & Liquidité',
        'tokenomics.distribution.table5.allocation': '10% (1 000 000)',
        'tokenomics.distribution.table5.vesting': 'Plancher de valeur (stablecoins)',
        'tokenomics.distribution.table6.category': 'Équipe & Opérations',
        'tokenomics.distribution.table6.allocation': '5% (500 000)',
        'tokenomics.distribution.table6.vesting': 'Vesting 36 mois',
        'tokenomics.distribution.table7.category': 'DAO communautaire',
        'tokenomics.distribution.table7.allocation': '5% (500 000)',
        'tokenomics.distribution.table7.vesting': 'Initiatives locales et votes',
        'tokenomics.distribution.note': 'Vesting développeurs/experts aligné sur des jalons livrables (open-source, modules éducatifs, projets associatifs).',
        'tokenomics.emission.title': 'Émission (Proof-of-Impact)',
        'tokenomics.emission.row1.action': '1h de mentorat',
        'tokenomics.emission.row1.validation': 'Coordinateur + DAO',
        'tokenomics.emission.row2.action': 'Projet livré (livrable tech/asso)',
        'tokenomics.emission.row2.validation': 'Comité Tarmak',
        'tokenomics.emission.row3.action': 'Don de 100 CHF',
        'tokenomics.emission.row3.validation': 'Smart contract de donation',
        'tokenomics.emission.row4.action': 'Formation certifiée (LMS)',
        'tokenomics.emission.row4.validation': 'Plateforme Tarmak',
        'tokenomics.emission.row5.action': 'Bourse de mobilité',
        'tokenomics.emission.row5.validation': 'Équipe opérationnelle',
        'tokenomics.emission.note': 'Chaque émission est liée à une donnée on-chain : bénéficiaire, livrable, horodatage.',
        'tokenomics.circulation.title': 'Utilisation (Burn & Circulation)',
        'tokenomics.circulation.item1.title': 'formations premium',
        'tokenomics.circulation.item1.text': 'événements, coworking.',
        'tokenomics.circulation.item2.title': 'Bourses de mobilité',
        'tokenomics.circulation.item2.text': '(TQ → subvention partielle, puis burn).',
        'tokenomics.circulation.item3.title': 'Parrainage',
        'tokenomics.circulation.item3.text': ': "impact staking" de TQ pour financer d\'autres jeunes.',
        'tokenomics.circulation.item4.title': 'Conversion',
        'tokenomics.circulation.item4.text': 'via la réserve (TQ ↔ CHF) selon règles DAO.',
        'tokenomics.circulation.item5.title': 'Visibilité partenaires',
        'tokenomics.circulation.item5.text': ': pages projets, badges, reporting d\'impact.',
        'tokenomics.reserve.title': 'Mécanisme de Réserve (CHF-backed)',
        'tokenomics.reserve.description': '10% de chaque don/mécénat est converti en stablecoins (USDC/CHF) et versé dans une réserve d\'impact. Cette réserve crée un plancher de valeur pour TQ et alimente la liquidité.',
        'tokenomics.reserve.item1.title': 'Pool DEX',
        'tokenomics.reserve.item1.text': '5% des flux pour la liquidité (ex. QuickSwap/Uniswap sur Polygon).',
        'tokenomics.reserve.item2.title': 'Buyback interne',
        'tokenomics.reserve.item2.text': 'rachat TQ par l\'association (fenêtres trimestrielles).',
        'tokenomics.reserve.item3.title': 'On-ramp CH',
        'tokenomics.reserve.item3.text': 'partenaires régulés (MtPelerin / banques crypto) pour TQ ↔ CHF.',
        'tokenomics.compliance.title': 'Cadre & Conformité (Suisse)',
        'tokenomics.compliance.item1.title': 'Utility token',
        'tokenomics.compliance.item1.text': 'à impact (non spéculatif par défaut, usage défini).',
        'tokenomics.compliance.item2.title': 'Transparence',
        'tokenomics.compliance.item2.text': 'rapports d\'impact publics (on-chain + PDF annuel).',
        'tokenomics.compliance.item3.title': 'Multi-sig',
        'tokenomics.compliance.item3.text': 'sur la trésorerie, audits de smart contracts, KYC pour conversions fiat.',
        'tokenomics.compliance.item4.title': 'DAO associative',
        'tokenomics.compliance.item4.text': 'l\'association demeure garante de la mission d\'intérêt général.',
        'tokenomics.governance.title': 'Gouvernance',
        'tokenomics.governance.item1': '🗳️ 1 TQ = 1 voix (plafond 2% / entité).',
        'tokenomics.governance.item2': '🏛️ Conseil d\'impact (investisseurs philantropiques & entreprises) : suivi KPI.',
        'tokenomics.governance.item3': '🧩 Budgets participatifs : bourses, hackathons, projets associatifs.',
        'tokenomics.alignment.title': 'Alignement Développeurs & Experts',
        'tokenomics.alignment.item1': '💼 Rémunération mixte CHF + TQ (vesting 24–36 mois).',
        'tokenomics.alignment.item2': '🏅 Bonus TQ pour livrables open-source et modules éducatifs.',
        'tokenomics.alignment.item3': '🎯 Primes à l\'impact : TQ additionnels si objectifs pédagogiques atteints.',
        'tokenomics.investors.title': 'Investisseurs & Philanthropes',
        'tokenomics.investors.item1': '💠 NFT "Impact Certificate" avec traçabilité des fonds.',
        'tokenomics.investors.item2': '💧 Accès à la réserve (règles DAO) + reporting on-chain.',
        'tokenomics.investors.item3': '👁️ Co-branding ESG : pages projets, badge partenaire.',
        'tokenomics.roadmap.title': 'Feuille de route (5 ans)',
        'tokenomics.roadmap.subtitle': 'Objectif : passer d\'un utility interne à une référence d\'impact token éducatif en Suisse.',
        'tokenomics.roadmap.year1.title': 'Année 1',
        'tokenomics.roadmap.year1.description': 'MVP token + DAO',
        'tokenomics.roadmap.year2.title': 'Année 2',
        'tokenomics.roadmap.year2.description': 'Adoption interne (10 entreprises, 100 jeunes)',
        'tokenomics.roadmap.year3.title': 'Année 3',
        'tokenomics.roadmap.year3.description': 'Réserve ≥ 50k CHF + DEX',
        'tokenomics.roadmap.year4.title': 'Année 4',
        'tokenomics.roadmap.year4.description': 'On-ramp CH (TQ ↔ CHF)',
        'tokenomics.roadmap.year5.title': 'Année 5',
        'tokenomics.roadmap.year5.description': 'Extension nationale (5 villes)',
        'tokenomics.nextsteps.title': 'Prochaines étapes (actionnable)',
        'tokenomics.nextsteps.item1': '📐 Finaliser la charte d\'usage et le cadre DAO.',
        'tokenomics.nextsteps.item2': '🧪 Déployer les smart contracts (ERC-20 + NFT Impact) sur Polygon.',
        'tokenomics.nextsteps.item3': '📊 Ouvrir le tableau de bord d\'impact (on-chain + KPI pédagogiques).',
        'tokenomics.nextsteps.item4': '💧 Mettre en place la réserve & la pool de liquidité initiale.',
        'tokenomics.nextsteps.item5': '🤝 Lancer la cohorte pilote (100 jeunes, 20 mentors, 10 entreprises).',
        'tokenomics.contact.title': 'Contact & Démo',
        'tokenomics.contact.description': 'Je te prépare volontiers un mini-site de démonstration (dashboard live, mint testnet, vote DAO, certificats NFT) pour tes rendez-vous partenaires & fondations.',
        'tokenomics.contact.cta1': 'Demander la démo',
        'tokenomics.contact.cta2': 'Retour en haut'
    }
};
