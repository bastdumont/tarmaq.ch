...
const translations = {
    ...
    en: {
        ...
        'charter.subtitle': 'Together, let\'s create a future where collective action transforms possibilities into realities.',
        'charter.quote': 'Don\'t ask what the world can do for you, but what you can do for the world. Share, act, dare, and create value that transcends wealth.',
        'charter.text.title': 'The Charter Text',
        'charter.text.preamble': 'Preamble: Convinced that youth is the engine of innovation and that the gap between training and market needs must be bridged, we commit through this charter to catalyze opportunities for the next generation in French-speaking Switzerland and to prepare talents for the jobs of tomorrow. We base our action on essential values: sharing rather than competing, action rather than complaining, audacity rather than worry, and creating value beyond mere material wealth.',
        'charter.text.article1.title': 'Article 1: Training and Access to Opportunity',
        'charter.text.article1.content': 'We commit to providing equitable access to the latest technologies and practical training. We will act so that every motivated young person, regardless of their background, can develop solid technical and personal skills to build their future with confidence.',
        'charter.text.article2.title': 'Article 2: Collaboration and Community Impact',
        'charter.text.article2.content': 'We commit to creating a virtuous circle by connecting young talents with non-profit organizations and local projects. We will promote learning through practice on concrete projects that strengthen the economic and social fabric of our community.',
        'charter.text.article3.title': 'Article 3: Innovation and Entrepreneurship',
        'charter.text.article3.content': 'We commit to encouraging and supporting initiative, creativity and entrepreneurship. We will provide an ecosystem of mentors, experts and cutting-edge equipment to transform innovative ideas into viable projects.',
        'charter.text.article4.title': 'Article 4: Mobility and International Openness',
        'charter.text.article4.content': 'We commit to promoting openness to the world. We will actively support young people in their international mobility projects, whether educational or professional, to promote cultural exchanges and the acquisition of global skills.',
        'charter.text.article5.title': 'Article 5: Our Fundamental Values',
        'charter.text.article5.intro': 'We commit to embodying and transmitting these essential values:',
        'charter.text.article5.value1.title': 'Share rather than compete',
        'charter.text.article5.value1.content': 'We believe in the power of collaboration and knowledge sharing. Collective success always surpasses individual victories.',
        'charter.text.article5.value2.title': 'Act rather than complain',
        'charter.text.article5.value2.content': 'In the face of challenges, we choose constructive action. Every problem is an opportunity to create an innovative solution.',
        'charter.text.article5.value3.title': 'Dare rather than worry',
        'charter.text.article5.value3.content': 'We encourage measured risk-taking and experimentation. Failure is not an end but a learning step.',
        'charter.text.article5.value4.title': 'Create value beyond wealth',
        'charter.text.article5.value4.content': 'We aim for a positive impact on society, the environment and individuals. Success is measured as much in terms of impact as in financial terms.',
        'charter.text.conclusion': 'By signing this charter, we join an active community that invests in youth to build a more collaborative, bolder and more meaningful future for all.',
        'charter.form.title': 'Support the vision',
        'charter.form.subtitle': 'Join our movement to transform values into concrete actions. Your commitment matters.',
        'charter.form.firstname': 'First name',
        'charter.form.lastname': 'Last name',
        'charter.form.email': 'Email address (optional)',
        'charter.form.consent': 'I certify that I have read and approve the terms of the charter.',
        'charter.form.consent_note': 'By signing, you agree that your first and last name will be displayed publicly in the list of signatories.',
        'charter.form.submit': 'I commit to act and share',
        'charter.signatories.title': 'The Pioneers of Change',
        'charter.signatories.subtitle': 'Join the',
        'charter.signatories.subtitle2': 'catalysts who are already transforming values into actions!',
        'charter.notification': 'Thank you for joining our movement of action and sharing!'
    },
    ...
    de: {
        ...
        // Charter Page
        'nav.charter': 'Charta',
        'charter.title': 'Engagement-Charta',
        'charter.subtitle': 'Gemeinsam schaffen wir eine Zukunft, in der kollektives Handeln Möglichkeiten in Realitäten verwandelt.',
        'charter.quote': 'Fragen Sie nicht, was die Welt für Sie tun kann, sondern was Sie für die Welt tun können. Teilen, handeln, wagen und Werte schaffen, die über Reichtum hinausgehen.',
        'charter.text.title': 'Der Charta-Text',
        'charter.text.preamble': 'Präambel: Überzeugt, dass die Jugend der Motor der Innovation ist und dass die Lücke zwischen Ausbildung und Marktbedürfnissen geschlossen werden muss, verpflichten wir uns durch diese Charta, Chancen für den Nachwuchs in der französischsprachigen Schweiz zu katalysieren und Talente für die Arbeitsplätze von morgen vorzubereiten. Wir stützen unser Handeln auf wesentliche Werte: Teilen statt Konkurrieren, Handeln statt Klagen, Wagemut statt Sorge und Werte schaffen, die über bloßen materiellen Reichtum hinausgehen.',
        'charter.text.article1.title': 'Artikel 1: Ausbildung und Zugang zu Chancen',
        'charter.text.article1.content': 'Wir verpflichten uns, einen gerechten Zugang zu den neuesten Technologien und praktischen Ausbildungen zu bieten. Wir werden handeln, damit jeder motivierte junge Mensch, unabhängig von seinem Hintergrund, solide technische und persönliche Fähigkeiten entwickeln kann, um seine Zukunft mit Vertrauen aufzubauen.',
        'charter.text.article2.title': 'Artikel 2: Zusammenarbeit und Gemeinschaftsauswirkung',
        'charter.text.article2.content': 'Wir verpflichten uns, einen virtuosen Kreis zu schaffen, indem wir junge Talente mit gemeinnützigen Organisationen und lokalen Projekten verbinden. Wir werden das Lernen durch Praxis an konkreten Projekten fördern, die das wirtschaftliche und soziale Gefüge unserer Gemeinschaft stärken.',
        'charter.text.article3.title': 'Artikel 3: Innovation und Unternehmergeist',
        'charter.text.article3.content': 'Wir verpflichten uns, Initiative, Kreativität und Unternehmertum zu fördern und zu unterstützen. Wir werden ein Ökosystem von Mentoren, Experten und modernster Ausrüstung bereitstellen, um innovative Ideen in lebensfähige Projekte zu verwandeln.',
        'charter.text.article4.title': 'Artikel 4: Mobilität und internationale Offenheit',
        'charter.text.article4.content': 'Wir verpflichten uns, die Offenheit zur Welt zu fördern. Wir werden junge Menschen aktiv in ihren internationalen Mobilitätsprojekten unterstützen, sei es bildungs- oder berufsbezogen, um kulturellen Austausch und den Erwerb globaler Fähigkeiten zu fördern.',
        'charter.text.article5.title': 'Artikel 5: Unsere Grundwerte',
        'charter.text.article5.intro': 'Wir verpflichten uns, diese wesentlichen Werte zu verkörpern und zu vermitteln:',
        'charter.text.article5.value1.title': 'Teilen statt konkurrieren',
        'charter.text.article5.value1.content': 'Wir glauben an die Kraft der Zusammenarbeit und des Wissensaustauschs. Kollektiver Erfolg übertrifft immer individuelle Siege.',
        'charter.text.article5.value2.title': 'Handeln statt klagen',
        'charter.text.article5.value2.content': 'Angesichts von Herausforderungen wählen wir konstruktives Handeln. Jedes Problem ist eine Gelegenheit, eine innovative Lösung zu schaffen.',
        'charter.text.article5.value3.title': 'Wagen statt sich sorgen',
        'charter.text.article5.value3.content': 'Wir ermutigen zu gemessenem Risikoverhalten und Experimentieren. Scheitern ist kein Ende, sondern ein Lernschritt.',
        'charter.text.article5.value4.title': 'Werte schaffen, die über Reichtum hinausgehen',
        'charter.text.article5.value4.content': 'Wir streben nach positiven Auswirkungen auf Gesellschaft, Umwelt und Individuen. Erfolg wird sowohl in Bezug auf Auswirkungen als auch in finanzieller Hinsicht gemessen.',
        'charter.text.conclusion': 'Durch die Unterzeichnung dieser Charta treten wir einer aktiven Gemeinschaft bei, die in die Jugend investiert, um eine kollaborativere, mutigere und sinnvollere Zukunft für alle aufzubauen.',
        'charter.form.title': 'Die Vision unterstützen',
        'charter.form.subtitle': 'Treten Sie unserer Bewegung bei, um Werte in konkrete Handlungen zu verwandeln. Ihr Engagement zählt.',
        'charter.form.firstname': 'Vorname',
        'charter.form.lastname': 'Nachname',
        'charter.form.email': 'E-Mail-Adresse (optional)',
        'charter.form.consent': 'Ich bestätige, dass ich die Bedingungen der Charta gelesen und genehmigt habe.',
        'charter.form.consent_note': 'Durch die Unterzeichnung stimmen Sie zu, dass Ihr Vor- und Nachname öffentlich in der Liste der Unterzeichner angezeigt werden.',
        'charter.form.submit': 'Ich verpflichte mich zu handeln und zu teilen',
        'charter.signatories.title': 'Die Pioniere des Wandels',
        'charter.signatories.subtitle': 'Treten Sie den',
        'charter.signatories.subtitle2': 'Katalysatoren bei, die bereits Werte in Handlungen verwandeln!',
        'charter.notification': 'Danke, dass Sie sich unserer Bewegung des Handelns und Teilens angeschlossen haben!'
    },
    ...
    it: {
        ...
        // Charter Page
        'nav.charter': 'Carta',
        'charter.title': 'Carta di Impegno',
        'charter.subtitle': 'Insieme, creiamo un futuro dove l\'azione collettiva trasforma le possibilità in realtà.',
        'charter.quote': 'Non chiedere cosa il mondo può fare per te, ma cosa puoi fare per il mondo. Condividi, agisci, osa e crea valore che trascende la ricchezza.',
        'charter.text.title': 'Il Testo della Carta',
        'charter.text.preamble': 'Preambolo: Convinti che i giovani siano il motore dell\'innovazione e che il divario tra formazione e bisogni del mercato debba essere colmato, ci impegniamo attraverso questa carta a catalizzare le opportunità per la nuova generazione della Svizzera romanda e a preparare i talenti per i lavori di domani. Fondiamo la nostra azione su valori essenziali: condividere piuttosto che competere, agire piuttosto che lamentarsi, osare piuttosto che preoccuparsi, e creare valore oltre la semplice ricchezza materiale.',
        'charter.text.article1.title': 'Articolo 1: Formazione e Accesso alle Opportunità',
        'charter.text.article1.content': 'Ci impegniamo a offrire un accesso equo alle ultime tecnologie e a formazioni pratiche. Agiremo affinché ogni giovane motivato, indipendentemente dal suo percorso, possa sviluppare competenze tecniche e personali solide per costruire il suo futuro con fiducia.',
        'charter.text.article2.title': 'Articolo 2: Collaborazione e Impatto Comunitario',
        'charter.text.article2.content': 'Ci impegniamo a creare un circolo virtuoso collegando i giovani talenti con organizzazioni non profit e progetti locali. Favoriremo l\'apprendimento attraverso la pratica su progetti concreti che rafforzano il tessuto economico e sociale della nostra comunità.',
        'charter.text.article3.title': 'Articolo 3: Innovazione e Spirito Imprenditoriale',
        'charter.text.article3.content': 'Ci impegniamo a incoraggiare e sostenere lo spirito di iniziativa, la creatività e l\'imprenditorialità. Metteremo a disposizione un ecosistema di mentori, esperti e attrezzature all\'avanguardia per trasformare le idee innovative in progetti fattibili.',
        'charter.text.article4.title': 'Articolo 4: Mobilità e Apertura Internazionale',
        'charter.text.article4.content': 'Ci impegniamo a promuovere l\'apertura al mondo. Sosterremo attivamente i giovani nei loro progetti di mobilità internazionale, siano essi educativi o professionali, per favorire gli scambi culturali e l\'acquisizione di competenze globali.',
        'charter.text.article5.title': 'Articolo 5: I Nostri Valori Fondamentali',
        'charter.text.article5.intro': 'Ci impegniamo a incarnare e trasmettere questi valori essenziali:',
        'charter.text.article5.value1.title': 'Condividere piuttosto che competere',
        'charter.text.article5.value1.content': 'Crediamo nella forza della collaborazione e della condivisione delle conoscenze. Il successo collettivo supera sempre le vittorie individuali.',
        'charter.text.article5.value2.title': 'Agire piuttosto che lamentarsi',
        'charter.text.article5.value2.content': 'Di fronte alle sfide, scegliamo l\'azione costruttiva. Ogni problema è un\'opportunità per creare una soluzione innovativa.',
        'charter.text.article5.value3.title': 'Osare piuttosto che preoccuparsi',
        'charter.text.article5.value3.content': 'Incoraggiamo l\'assunzione di rischi misurati e la sperimentazione. Il fallimento non è una fine ma una tappa di apprendimento.',
        'charter.text.article5.value4.title': 'Creare valore oltre la ricchezza',
        'charter.text.article5.value4.content': 'Miriamo a un impatto positivo sulla società, l\'ambiente e gli individui. Il successo si misura tanto in termini di impatto quanto in termini finanziari.',
        'charter.text.conclusion': 'Firmando questa carta, ci uniamo a una comunità attiva che investe nei giovani per costruire un futuro più collaborativo, più audace e più significativo per tutti.',
        'charter.form.title': 'Sostenere la visione',
        'charter.form.subtitle': 'Unisciti al nostro movimento per trasformare i valori in azioni concrete. Il tuo impegno conta.',
        'charter.form.firstname': 'Nome',
        'charter.form.lastname': 'Cognome',
        'charter.form.email': 'Indirizzo email (opzionale)',
        'charter.form.consent': 'Certifico di aver letto e approvato i termini della carta.',
        'charter.form.consent_note': 'Firmando, accetti che il tuo nome e cognome siano visualizzati pubblicamente nella lista dei firmatari.',
        'charter.form.submit': 'Mi impegno ad agire e condividere',
        'charter.signatories.title': 'I Pionieri del Cambiamento',
        'charter.signatories.subtitle': 'Unisciti ai',
        'charter.signatories.subtitle2': 'catalizzatori che stanno già trasformando i valori in azioni!',
        'charter.notification': 'Grazie per esserti unito al nostro movimento di azione e condivisione!'
    }
};
